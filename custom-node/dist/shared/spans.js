...
exports.buildLlmSpan = buildLlmSpan;
exports.buildToolSpan = buildToolSpan;
exports.buildHttpRequestSpan = buildHttpRequestSpan;
const LLM_URL = 'https://api.openai.com/v1/chat/completions';
function hex(len) {
    return Array.from({ length: len }, () => Math.floor(Math.random() * 16).toString(16)).join('');
}
function baseSpan(startMs, endMs) {
 ...
 */
function buildHttpRequestSpan(opts) {
